              ...
              <div class="longi-mina__form">
                <template v-if="status === 0">
                  ...
                  <el-row type="flex" justify="space-between">
                    ...
                    <el-col class="action">
                      <el-checkbox v-model="memory"><a>记住我</a></el-checkbox>
                ...
                <template v-if="status === 1">
                  ...
                  >
                    <el-form-item prop="mobile">
                      <el-input v-model="findForm.mobile" placeholder="手机号">
                    ...
                    <el-form-item prop="code">
                      <el-input v-model="findForm.code" placeholder="手机验证码"></el-input>
                    </el-form-item>
...
export default {
  ...
  methods: {
    ...
    send() {
      ...
      axios.get(`https://hotelapi.xqtinfo.cn/hotel/common/sendSmsCode?mobile=${mobile}`).then(() => {
        this.$message({
          message: '发送成功',
          type: 'success'
        });
