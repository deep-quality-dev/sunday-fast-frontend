  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        >新增</el-button>
        <el-button
          v-if="isAuth('hotel:hoteladvertising:delete')"
          type="danger"
          @click="deleteHandle()"
...
<script>
import AddOrUpdate from "./hoteladvertising-add-or-update";
export default {
  data() {
    return {
      dataForm: {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl("/hotel/hoteladvertising/list"),
        method: "get",
    ...
    deleteHandle(id) {
      ...
      this.$confirm(
        ...
        this.$http({
          url: this.$http.adornUrl("/hotel/hoteladvertising/delete"),
          method: "post",
