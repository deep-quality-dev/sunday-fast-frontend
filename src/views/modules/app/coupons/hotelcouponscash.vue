  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button
          v-if="isAuth('hotel:hotelcouponscash:save')"
          type="primary"
          @click="addOrUpdateHandle()"
        >新增</el-button>
        <el-button
          v-if="isAuth('hotel:hotelcouponscash:delete')"
          type="danger"
          @click="deleteHandle()"
...
<script>
import AddOrUpdate from "./hotelcouponscash-add-or-update";
export default {
  data() {
    return {
      dataForm: {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl("/hotel/hotelcouponscash/list"),
        method: "get",
    ...
    deleteHandle(id) {
      ...
      this.$confirm(
        ...
        this.$http({
          url: this.$http.adornUrl("/hotel/hotelcouponscash/delete"),
          method: "post",
